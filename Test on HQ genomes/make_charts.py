...
fig.tight_layout()
fig.savefig("Test on HQ genomes/charts/01_coverage.png", dpi=180)
plt.close(fig)
...
fig.tight_layout()
fig.savefig("Test on HQ genomes/charts/02_distribution.png", dpi=180)
plt.close(fig)
...
fig.tight_layout()
fig.savefig("Test on HQ genomes/charts/03_by_ecosystem.png", dpi=180)
plt.close(fig)
...
fig.tight_layout()
fig.savefig("Test on HQ genomes/charts/04_gc_vs_growth.png", dpi=180)
plt.close(fig)

print("wrote 4 charts to Test on HQ genomes/charts/")
